...
Provided are two files for this assignment. One is a sample file where we give you the sum for your testing 
and the other is the actual data you need to process for the assignment.

Sample data: http://py4e-data.dr-chuck.net/comments_42.html (Sum=2553)
Actual data: http://py4e-data.dr-chuck.net/comments_1097716.html (Sum ends with 69)
...
# My solution to http://py4e-data.dr-chuck.net/comments_1097716.html # Sum ends with 69
...
url = 'http://py4e-data.dr-chuck.net/comments_1097716.html'
